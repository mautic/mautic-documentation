...
When using the file upload field there is a limit of 1,000 submissions using the same filename. Note that you can attached the submitted files in the "Send form result" action.
