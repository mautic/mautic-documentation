...
- When you make your mapping, you have an option to skip the import on fields where a value is already existing on the contact. That setting will allow you to avoid erasing already existing data in your Mautic contacts.
...
![import history](import-history-button.png)
