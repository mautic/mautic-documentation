...
- view the source of the send email
- copy the tracking URL (probably at the bottom if the source file)
- open an incognito browser and past the url
- a blank (black) page should show. Not an error pag lik 404 or file not found
...
- it seems there are multiple versions of the plugin for Outlook. It could be that the URL is /index.php/plugin
- having said that: In my case a new contact still isn't created (2.16)
