...
3) Ensure that the URL defined either matches _exactly_ the URL visited or use a wildcard (note that the [URL can include the schema, host/domain, path, query parameters, and/or fragment][URL can include the schema, host/domain, path, query parameters, and/or fragment]).
...
[URL can include the schema, host/domain, path, query parameters, and/or fragment]: <https://en.wikipedia.org/wiki/Uniform_Resource_Locator>