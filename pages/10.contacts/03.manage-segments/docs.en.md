...
* Using `contains` or `does not contain` operators on text type fields also offer you the ability to paste a list of values from clipboard you've been copying from a spreadsheet column such as Microsoft Excel and Google Sheets.
