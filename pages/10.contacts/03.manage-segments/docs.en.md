...
* Using `contains` or `not contains` operator on text type fields also offer you the ability to paste a list of values from clipboard you've been copying from Spreadsheet column (Microsoft Excel and Google Spreadsheet).
